...
export const CHAT_HEADER_BASE =
  "flex items-center gap-2 py-4 px-4 bg-[var(--chat-header-bg)] text-[var(--chat-text)] border-b border-[var(--chat-border)] shrink-0 z-10";
...
export const CHAT_BODY =
  "flex-1 min-h-0 flex flex-col bg-[var(--chat-bg)] [background-image:var(--chat-wallpaper)] [background-size:100px_100px]";
