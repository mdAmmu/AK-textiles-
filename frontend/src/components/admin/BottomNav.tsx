...
export default function BottomNav() {
  ...
  return (
    <nav className="absolute bottom-0 left-0 right-0 flex items-stretch justify-around bg-white dark:bg-[#1e2530] border-t border-[#eef1ee] dark:border-[#232d3a] shadow-[0_-4px_18px_rgba(15,157,110,0.08)] dark:shadow-none pb-[env(safe-area-inset-bottom)] shrink-0 z-10">
